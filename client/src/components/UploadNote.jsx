            ...
            <form onSubmit={submitFile} className='max-w-screen-md mx-auto'>
                <div className="justify-center min-h-[90vh] pt-[20px] pr-0 pb-[20px] pl-0 flex flex-col items-center border-2 shadow-lg border-gray-600">
                    ...
                    <div className="relative w-[550px] ">
                        ...
                        <button type='submit' className='w-full h-full text-white transition-all duration-300 transform group-hover:translate-x-full ease justify-center items-center cursor-pointer relative inline-flex rounded-xl bg-blue-500 hover:bg-blue-600'>Submit</button>
